...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_background/sky.jpg"));





    SDL_Texture* backgroundFloor = loadTexture("./Assets/water 2.png");
    SDL_Texture* backgroundSky = loadTexture("./Assets/boat.png");
